...
//			break;
		...
		case 5998:
			sendNpcChat3("Only <img=4>@red@Donators @bla@can access the Donator Zone.", "Interested in becoming an SkyScapeLive <img=4>@red@Donator@bla@?", "Go to the bottom of your quest tab and click the <img=19>@yel@Store.", c.talkingNpc, "<img=4>Donation Informative<img=4>");
			c.nextChat = 0;
			break;
		...
		case 55872:
			...
			break;
		case 55873:
			sendNpcChat2("Hello, my name is Banky.", "I was hired by Exotic to be a travelling banker!", c.talkingNpc, "Banky The Banker");
			c.nextChat = 0;
			break;
		case 55875:
		...
		case 14011:
			...
			break;
		case 14012:
			sendPlayerChat3("Yeah! I've never seen one before.", "I guess it's one small step for NPC's,", "one giant leap for Exotic!");
			c.nextChat = 14013;
			break;
		case 14013:
		...
		case 673:
			sendNpcChat("Welcome To SkyScapeLive!", "Please choose your gamemode.", "Warning: This serer is in ALPHA!");
			c.nextChat = 646;
			break;
