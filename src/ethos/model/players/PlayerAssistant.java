...
public class PlayerAssistant {
	...
	public void loadQuests() {
		...
		sendFrame126(" @or1@Sky Scape Live", 29155);
		...
		sendFrame126("@or2@<img=14> SkyScapeLive Channel: @or1@Click Here", 29178);
		sendFrame126("@or2@<img=11> SkyScapeLive Discord: @or1@Click Here", 29179);
		sendFrame126("@or2@<img=19> No Store ATM: @or1@Click Here", 29180);
...
public void sendFrame107() {
	...
	public void addStarter() {
		...
		if (occurances < 3) {
			...
			c.sendMessage("You did not receive a starter pack because you have already received three.");
		}
	}
