...
import ethos.model.minigames.raids.bosses.GreatOlm;
	...
	public void initialize() {
		try {
			...
			/*if (Config.DOUBLE_DROPS && Config.DOUBLE_VOTE_INCENTIVES)
				sendMessage("@cr10@Vote and receive 2x drops and 2x vote rewards.");
			if (DoubleExperience.isDoubleExperience(this))
				sendMessage("@cr10@Bonus Weekend is @red@LIVE@bla@! Bonus voting, PKP and XP!");
	...
	public void process() {
		...
		/*if (this.playTime % 3600 == 0 && !isIdle && !trading){
			if (getHourlyBoxToggle() == true) {
				...
				sendMessage("[ @red@Reward @bla@] <img=1>@blu@Thank you for continuing to play Exotic, here is an @red@Hourly Reward Box@bla@!");
			} else {
