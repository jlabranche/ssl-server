...
//			c.getDH().sendDialogues(12000, -1);
		...
		case 113239:
			...
			c.forcedChat("I've played SkyScapeLive for a total of : " + time);
			break;
		case 113240:
		...
		case 113250: //yt
			...
			break;
			case 113251: //Discord
				c.getPA().sendFrame126("https://discord.gg/juFMGCM", 12000);
				//https://www.youtube.com/user/DopeRsps/videos
				break;
			case 113252: //Store
...
//			break;
		...
		case 108006: // items kept on death
			...
			c.getPA().sendFrame126("Exotic - Items Kept on Death", 17103);
