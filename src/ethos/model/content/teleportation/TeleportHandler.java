...
public class TeleportHandler {
	...
	String[] cityNames = { "Select your City Teleport", "Varrock", "Yanille", "Edgeville", "Lumbridge", "Ardougne",
			"Neitiznot", "Karamja", "Falador", "Taverly", "Camelot", "Catherby", "Al Kharid", "Morytania", "Waterbirth", "Lletya", "Burthorpe", "Entrana", "Draynor", "Trollheim", "" };
	...
	String[] otherNames = { "Select your Skilling Teleport", "Slayer Masters", "Lands End", "Skillers Cove",
			"Woodcutting Guild", "Farming Patches", "Agility - Grace", "Hunter", "Puro Puro", "Mining Guild", "", "",
			"", "", "", "", "", "", "", "", "" };
	...
	public void handleTeleports(Player player, int Id) {
		...
		case 51023:
		case 117186:
			if (c.getRights().isOrInherits(Right.DONATOR) || c.getRights().isOrInherits(Right.SUPER_DONATOR) ||
					c.getRights().isOrInherits(Right.LEGENDARY) ||
					c.getRights().isOrInherits(Right.EXTREME_DONATOR) ||
					c.getRights().isOrInherits(Right.UBER_DONATOR) ||
					c.getRights().isOrInherits(Right.MAX_DONATOR) ||
		...
		case 254026: // Button 1
			...
			if (player.teleSelected == 0) { // Monsters - Rock Crabs
				...
				if (c.amDonated >= 10 || c.getRights().isOrInherits(Right.OWNER)) {
					player.getPA().startTeleport(2852, 2954, 0, "modern");
